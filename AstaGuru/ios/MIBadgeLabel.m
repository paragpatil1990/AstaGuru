...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSaveGState(ctx);
    {
        ...
        UIFont *font= [UIFont fontWithName:@"WorkSans-Regular" size:13];

        const CGSize textSize = [self.text sizeWithAttributes:@{ NSFontAttributeName:font}];
//        [self.text sizeWithFont:[UIFont systemFontOfSize:13.0f]];
        ...
        [self.text drawInRect:textFrame withAttributes:@{NSFontAttributeName:font}];
