...
//        _bottomImageView.image = [self.dataSource slideShow:self imageForPosition:KASlideShowPositionBottom];
        ...
        [self.dataSource slideShow:self imageForPosition:KASlideShowPositionTop imageView:_topImageView index:_currentIndex];
        [self.dataSource slideShow:self imageForPosition:KASlideShowPositionBottom imageView:_bottomImageView index:_currentIndex];
...
- (void) emptyAndAddImages:(NSArray *)image_s
{
    [self.images removeAllObjects];
    _currentIndex = 0;
    for (UIImage *image in image_s)
    {
        [self addImage:image];
    }
}
...
//            _bottomImageView.image = [self.dataSource slideShow:self imageForPosition:KASlideShowPositionBottom];
            NSUInteger nextIndex = (_currentIndex+1)%[self.images count];
            [self.dataSource slideShow:self imageForPosition:KASlideShowPositionTop imageView:_topImageView index:_currentIndex];
            [self.dataSource slideShow:self imageForPosition:KASlideShowPositionBottom imageView:_bottomImageView index:nextIndex];
            _currentIndex = nextIndex;
        }
        else
        {
...
//            [self.dataSource slideShow:self imageForPosition:KASlideShowPositionTop imageView:_topImageView];
//            [self.dataSource slideShow:self imageForPosition:KASlideShowPositionBottom imageView:_bottomImageView];
        } else {
...
//    UITapGestureRecognizer *gesture = (UITapGestureRecognizer *)sender;
    ...
    [self.delegate kaSlideShowDidSelect:self atIndex:_currentIndex];
